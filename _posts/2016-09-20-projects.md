...
I also use Wren at [wren.soupmode.com](http://wren.soupmode.com) (test for code development site), [boghop.com](http://boghop.com), <a href="gopher://boghop.net">gopher://boghop.net</a>, and [zwdqwr2p2xwkpbyv.onion](http://zwdqwr2p2xwkpbyv.onion). I also use Wren to manage [sawv.org](http://sawv.org), which will replace boghop.com. 

The .onion site runs on my home Linux computer, when the computer is powered on. I used the site to test Tor. I created the gopher site to test the gopher protocol. 

To view the onion and gopher sites, special browser clients are required. The gopher site, however, can be viewed with a normal web browser through [this proxy](http://gopher.floodgap.com/gopher/gw?a=gopher%3A%2F%2Fboghop.net).
...
If users's CMS supports sending Webmentions, then their code can access the Warbler Webmention API endpoint.
...
* <a href="gopher://boghop.net">gopher://boghop.net</a> - requires a Gopher-supported client to view the site.
...
* <http://crochet.soupmode.com> - Scaup
